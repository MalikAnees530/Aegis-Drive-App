...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final TomtomLibraryAccessors laccForTomtomLibraryAccessors = new TomtomLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at tomtom
     */
    public TomtomLibraryAccessors getTomtom() {
        return laccForTomtomLibraryAccessors;
    }
    ...
    public static class TomtomLibraryAccessors extends SubDependencyFactory {

        public TomtomLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for maps (com.tomtom.sdk.maps:map-display)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getMaps() {
                return create("tomtom.maps");
        }

            /**
             * Creates a dependency provider for routing (com.tomtom.sdk.routing:routing-client)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getRouting() {
                return create("tomtom.routing");
        }

            /**
             * Creates a dependency provider for search (com.tomtom.sdk.search:search-client)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getSearch() {
                return create("tomtom.search");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: tomtom (1.15.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getTomtom() { return getVersion("tomtom"); }
